...
<head>
    ...
    <title>VESIT ELECTRONICS DEPARTMENT</title>
...
<body>
    <header class="tm-site-header">
        <h1 class="tm-mt-0 tm-mb-15"><span class="tm-color-primary">VESIT</span> <span class="tm-color-gray-2">ELECTRONICS DEPARTMENT</span></h1>
        <em class="tm-tagline tm-color-light-gray">Online Digital Library</em>
    </header>
    ...
    <div class="tm-container">
        <nav class="tm-main-nav">
            <ul id="inline-popups">
                ...
                <li class="tm-nav-item">
                    <a href="#login" data-effect="mfp-move-from-top" class="tm-nav-link" id="tm-login-link">
                         LOGIN
                        <i class="far fa-3x fa-images"></i>
                    </a>
                </li>
                <li class="tm-nav-item">
                    <a href="#books" data-effect="mfp-move-from-top" class="tm-nav-link">
                        BOOKS
                ...
                <div class="tm-col tm-bg-white tm-intro-pad">
                    ...
                    <div class="tm-row tm-content-row">
                        <div class="tm-col-6 tm-intro-col-l">
                            <p>
                                The COVID-19 pandemic has impacted almost every sector across the globe. Nowadays due to the lockdown period, students are deprived of getting access to the library.
                                As we all know during this pandemic students are attending college lectures through online mode and are facing difficulties in acquiring proper text material. During these lockdowns books are not available easily at the bookstore,so through this project, we try to solve this problem by creating an online digital library where all the books are present at one’s end for all.
                                Students, as well as teachers, will be able to find any book here . 
                                 </p>
        ...
        <div id="books" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            
            <div class="tm-testimonials-inner">
                <h2 class="tm-color-gray tm-testimonial-col tm-page-title">Books Section</h2>               
                <a href="books.php">
        ...
        <div id="about" class="popup mfp-with-anim mfp-hide tm-bg-gray">
            ...
            <div class="tm-row tm-content-row">
                        <div class="tm-col-6 tm-intro-col-l">
                            <p>
                            Vivekanand Education Society was founded in 1959 by Shri. Hashu Advani, along with ten other members, who shared the dream of providing qualitative education to the youth of our country. 
                            In the beginning, Vivekanand Education Society had a very modest launch, with just 256 students and six classrooms, in the humble barracks of Chembur Camp. But today, it proudly boast of having 3, 75, 000 sq. ft. land, housing 12 buildings and 28 Institutions, ranging from a crèche to Ph.D. Centers.
                             It has over 2000 teaching and non-teaching staff, and more than 18,000 students who pass through its hallowed portals each year.
                            </p>
                            <p>
                            ...
                            This institute is affiliated to the University of Mumbai and follows the rules and regulations laid down by government, AICTE, and University for admission; 51% reserved for Sindhi Linguistic minority and 49% through CAP test. 
                            The management quota has been surrendered to DTE to make admission centralized.
                                 </p>
                                 <div class="tm-row tm-content-column">
                                                   
                    <img src="img/intro 1.jpg" alt="Image" class="tm-mb-30">
                    ...
                    <div class="mapouter tm-mb-40">
                        <div class="gmap_canvas">
                            <iframe width="100%" height="520" id="gmap_canvas"
                                src="https://www.google.com/maps/place/Vivekanand+Education+Society's+Institute+Of+Technology+(VESIT)/@19.0453123,72.8867702,17z/data=!3m1!4b1!4m5!3m4!1s0x3be7c8add9569a29:0xb7ad04bf9a389df7!8m2!3d19.0453072!4d72.8889589"
    ...
    <footer class="tm-footer">
        ...
        <a href="https://vesit.ves.ac.in" title="By VESIT Chembur" target="_parent" rel="nofollow">ELECTRONICS DEPARTMENT</a></span>
</footer>
